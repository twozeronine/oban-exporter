defmodule ObanExporter.PromEx do
  ...
  1. Update your configuration (config.exs, dev.exs, prod.exs, releases.exs, etc) to
     ...
     ```
     config :oban_exporter, ObanExporter.PromEx,
       disabled: false,
  ...
  def plugins do
    [
      ...
      # Plugins.Application,
      # Plugins.Beam
      # {Plugins.Phoenix, router: ObanExporterWeb.Router, endpoint: ObanExporterWeb.Endpoint},
      # Plugins.Ecto,
      # Plugins.Oban,
      ...
      # ObanExporter.Users.PromExPlugin
    ]
  end
  ...
  def dashboards do
    [
      ...
      # {:oban_exporter, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
